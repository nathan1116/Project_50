...
class MainApp(QMainWindow, ui):
    ...
    def data(self):
        ...
        try:
            sql = "select Opername,pihao,IndexNo,Barcode_1,Barcode_2,InjuryDes,Result,jianyanyuan,Time,Note from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' order by IndexNo"
    ...
    def tongji(self):
        ...
        sql0 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测'"
        cur.execute(sql0)
        zs = cur.fetchall()
        for z in zs:
            z = list(z)
        ...
        sql1 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '合格'"
        cur.execute(sql1)
        hs = cur.fetchall()
        for h in hs:
            h = list(h)
        ...
        sql2 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格'"
        cur.execute(sql2)
        bs = cur.fetchall()
        for b in bs:
            b = list(b)
        ...
        sql21 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格' and InjuryDes like '%外%'"
        cur.execute(sql21)
        bas = cur.fetchall()
        for ba in bas:
            ba = list(ba)
        ...
        sql22 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格' and InjuryDes like '%内%'"
        cur.execute(sql22)
        bbs = cur.fetchall()
        for bb in bbs:
            bb = list(bb)
        ...
        sql3 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '待定'"
        cur.execute(sql3)
        ds = cur.fetchall()
        for d in ds:
            d = list(d)
        ...
        sql000 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Time like '%"+str(Time)+"%'"
        cur.execute(sql000)
        zs = cur.fetchall()
        for z in zs:
            z = list(z)
        ...
        sql111 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '合格' and Time like '%"+str(Time)+"%'"
        cur.execute(sql111)
        hs = cur.fetchall()
        for h in hs:
            h = list(h)
        ...
        sql222 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格' and Time like '%"+str(Time)+"%'"
        cur.execute(sql222)
        bs = cur.fetchall()
        for b in bs:
            b = list(b)
        ...
        sql2111 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格' and InjuryDes like '%外%' and Time like '%"+str(Time)+"%'"
        cur.execute(sql2111)
        bas = cur.fetchall()
        for ba in bas:
            ba = list(ba)
        ...
        sql2222 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '不合格' and InjuryDes like '%内%' and Time like '%"+str(Time)+"%'"
        cur.execute(sql2222)
        bbs = cur.fetchall()
        for bb in bbs:
            bb = list(bb)
        ...
        sql322 = "select COUNT(*) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测' and Result = '待定' and Time like '%"+str(Time)+"%'"
        cur.execute(sql322)
        ds = cur.fetchall()
        for d in ds:
            d = list(d)
    ...
    def Barcode_Scan(self):
        ...
        if num != 0:
            ...
            if dum != 0:
                ...
                sql = "select count(*) from Report where (Opername='源验宏观检测' and Barcode_1='"+str(Barcode)+"') or (Opername='源验宏观检测' and Barcode_2='"+str(Barcode)+"')"
    ...
    def tijiao(self):
        ...
        try:
            ...
            cur.execute("select max(IndexNo) from Report where pihao = '"+str(pihao)+"' and Opername= '源验宏观检测'")
            maxs = cur.fetchall()
            ...
            if self.hege_btn.isChecked() is True:
                sql = "insert into Report (Opername,pihao,IndexNo,Barcode_1,Barcode_2,InjuryDes,Result,jianyanyuan,Time,Note) values ('源验宏观检测','"+str(pihao)+"','"+str(IndexNo)+"','"+str(Barcode_1)+"','"+str(Barcode_2)+"','无超标缺陷','合格','"+str(jianyanyuan)+"','"+str(Time)+"','"+str(biaozhun)+"')"

            if self.buhege_btn.isChecked() is True:
                sql = "insert into Report (Opername,pihao,IndexNo,Barcode_1,Barcode_2,InjuryDes,Result,jianyanyuan,Time,Note) values ('源验宏观检测','"+str(pihao)+"','"+str(IndexNo)+"','"+str(Barcode_1)+"','"+str(Barcode_2)+"','"+str(shangqing)+"','不合格','"+str(jianyanyuan)+"','"+str(Time)+"','"+str(biaozhun)+"')"

            if self.daiding_btn.isChecked() is True:
                sql = "insert into Report (Opername,pihao,IndexNo,Barcode_1,Barcode_2,InjuryDes,Result,jianyanyuan,Time,Note) values ('源验宏观检测','"+str(pihao)+"','"+str(IndexNo)+"','"+str(Barcode_1)+"','"+str(Barcode_2)+"','"+str(shangqing)+"','待定','"+str(jianyanyuan)+"','"+str(Time)+"','"+str(biaozhun)+"')"
    ...
    def youjian(self,pos):
        ...
        if action == item1:
            ...
            sql = "delete from Report where pihao = '"+str(pihao)+"' and IndexNo = '"+str(dele)+"' and Opername= '源验宏观检测' "
            cur.execute(sql)
            conn50.commit()
            conn50.close()
            self.data()
        ...
        if action == item2:
            ...
            sql = "update Report set  Result = '合格',InjuryDes='无超标缺陷' where pihao = '"+str(pihao)+"' and IndexNo = '"+str(upd)+"' and Opername= '源验宏观检测'"
            cur.execute(sql)
            conn50.commit()
            conn50.close()
            self.show_Barcode.clear()
        ...
        if action == item3:
            ...
            upd = table_data[row_num][2]            
            upd = str(int(upd)).zfill(3)           
            sql = "update Report set  Result = '不合格',InjuryDes='"+str(shangqing)+"' where pihao = '"+str(pihao)+"' and IndexNo = '"+str(upd)+"' and Opername= '源验宏观检测'"
            cur.execute(sql)
            conn50.commit()
            conn50.close()
            self.show_Barcode.clear()
        ...
        if action == item4:
            ...
            upd = table_data[row_num][2]
            upd = str(int(upd)).zfill(3)
            sql = "update Report set  Result = '待定',InjuryDes='外表面' where pihao = '"+str(pihao)+"' and IndexNo = '"+str(upd)+"' and Opername= '源验宏观检测'"
            cur.execute(sql)
            conn50.commit()
            conn50.close()
            self.show_Barcode.clear()
